...
export const postNewPokemon = newPokemon => async dispatch => {
...
export const editPokemon = editPokemon => async dispatch => {
	const res = await fetch(`/api/pokemon/${editPokemon.id}`, {
		method: "PUT",
		headers: {
			"Content-Type": "application/json"
		},
